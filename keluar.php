...
if (isset($_POST['id_kendaraan'])) {
    ...
    query("UPDATE tb_users SET jam_keluar='$jam_keluar',status='Out' WHERE id_kendaraan='$id_kendaraan'");
}

$kendaraan_in = query("SELECT no_kendaraan FROM tb_users WHERE status='In'");

if (isset($_POST['cari_kendaraan'])) {
    $no_kendaraan     = $_POST['no_kendaraan'];
    $jam_keluar     = $_POST['jam_keluar'];

    $data = query("SELECT * FROM tb_users WHERE no_kendaraan='$no_kendaraan'");
